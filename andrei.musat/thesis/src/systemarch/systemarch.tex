...
is then given to the connection router that it may begin the operating on the edges.
...
\item Second, those connections which did not match the criterias from step one are corrected (they are deviated to avoid 
