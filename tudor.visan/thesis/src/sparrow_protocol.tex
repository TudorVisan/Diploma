...
\todo{Stuff about network topology and traffic patterns?}
...
Firstly, there may be no root nodes
...
listening period. \todo{citation needed :)}
...
registration process, may be corrupted by a scheduled transmission \todo{cred ca s-ar putea evita} or other
...
responsible for estimating the duration of the callback. If the delay \todo{estimation?} is too
