...
for WSNs in order to monitor volcanic activity\cite{liu2013volcanic}. This new algorithm, using data gathered from the sensors, would determine as accurately as 
