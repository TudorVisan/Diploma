...
\begin{figure}[ht] \centering
\includegraphics[width=0.75\textwidth]{img/algdesing/vertex_reduction_step_1.png \label{vertex1}}
\caption{The initial representation of the graph and the configuration after one merge step} \end{figure}

\begin{figure}[ht] \centering
\includegraphics[width=0.75\textwidth]{img/algdesing/vertex_reduction_step_2.png \label{vertex2}}
\caption{Graph representation after two more reduction steps.} \end{figure}

\begin{figure}[ht] \centering
\includegraphics[width=0.65\textwidth]{img/algdesing/vertex_reduction_3.png \label{vertex3}}
...
\begin{figure}[ht] \centering
\includegraphics[width=0.65\textwidth]{img/algdesing/grid_example.png \label{grid}}
...
\begin{figure}[ht] \centering
\includegraphics[width=0.2\textwidth]{img/algdesing/recombination.png \label{rec1}}
\caption{Node N does not satisfy the distance threshold.} \end{figure}

\begin{figure}[ht] \centering
\includegraphics[width=0.65\textwidth]{img/algdesing/recombinationposib.png \label{rec2}}
