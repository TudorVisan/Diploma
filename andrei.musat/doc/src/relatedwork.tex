...
Regarding connection algorithms, most software today either use techniques such as shortest path connection \cite{dreyfus1969appraisal}
, orthogonal edge routing \cite{eiglsperger2004automatic} or various routing mechanics built around heuristics. Each approach tries to find a 
