...
above or bellow the refence value of 1G. The calculated data is gathered in sent periodically by the controller to the 
...
It is considered that a node has detected an earquake if the values oscilate strongly over the 1G reference value, reaching peaks at 2G+.
