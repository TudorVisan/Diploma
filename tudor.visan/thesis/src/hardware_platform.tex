...
management interface  \todo{unit?} and sleep modes. This allows the user to deactivate
peripherals and put the CPU into various sleep modes in order to preserve
power. In its most efficient sleep state the microcontroller utilises \todo{draws?} only 0.25
...
\begin{figure}[ht]
	...
	\end{center}
	\caption{\small \itshape{Sparrowv3 node architecture \todo{prea mic scrisul}}}
\end{figure}
...
\begin{figure}[ht]
	...
	\end{center}
	\caption{\small \itshape{SparrowDongle architecture \todo{scrisul  e prea mic}}}
\end{figure}
