...
The placing algorithm is at its core a genetic algorithm which uses
...
evolution process will continue until either stability has been achieved: there is an
