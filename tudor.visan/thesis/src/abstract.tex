...
surrounding environment is order to enable longer and more intense periods of
activity while preserving battery life. To this end we divided the network
nodes into two categories: leaf/measuring nodes, which run at very low
